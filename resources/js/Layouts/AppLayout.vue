    ...
    data(){
        return{
            navStyles: {
                ...
                left: "0",
                width: "100%",
                zIndex: 10, // Ensures nav is above the header
                background: "transparent", // Or set a semi-transparent background
            },
        }
    }
...
<!--<template>
    ...
    <div>
        ...
        <div class=" relative min-h-screen bg-gray-100">
            ...
            <Header :head-sub-title="headSubTitle" :head-title="headTitle">
                <BannerFix />
            <nav class="border-b border-gray-100" :style="navStyles">
