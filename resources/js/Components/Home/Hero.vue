  ...
  <section id="content" class="home__splash wf-section">
    <div class="home__splashinner">
        ...
        <div class="home__splash__callout" ref="callout">
            <div class="home__splash__callout__inner">
...
onMounted(() => {
    ...
    // Remove mouseleave event listener since button.value is a Vue component
    // and doesn't support addEventListener directly
    anime({
        targets: '.alansbutt',
        scale: 1,
        duration: 200,
