...
<link rel="stylesheet" href="https://use.typekit.net/zxh3cjp.css">
    ...
    <div class="Discovery__related">
      <div class="Discovery__related__readmore">
        <p class="Discovery__related__description" tabindex="0">
          Based on your personality and interests, these are our top education
          picks for you so far. Get more star ratings when you finish the
          assessment!
        </p>
      </div>
      <div class="Discovery__related__content">
        <ul class="Discovery__MemberCareerMatches">
          <div
            ...
            aria-labelledby="HorizontalCard-undefined"
          >
            <img
              class="HorizontalCard-image"
              src="https://res.cloudinary.com/hnpb47ejt/image/upload/c_fill,h_160,q_80,w_160/v1727983767/kawnatp284eo1akskye7.jpg"
              alt=""
              role="presentation"
              aria-hidden="true"
            />
            <div class="HorizontalCard-wrap">
              <div id="HorizontalCard-undefined" class="HorizontalCard-name">
                Game Design
              </div>
              <div class="Stars" aria-label="5 out of 5">
                <svg
                  ...
                  data-prefix="fas"
                  data-icon="star"
                  class="svg-inline--fa fa-star fa-fw fa-sm Stars__star Stars__star--full"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 576 512"
      ...
      <div class="Discovery__related__feedback">
        ...
        >
          ...
          ><button
            class="DiscoveryFeedback-button alans-butt--grey"
            tabindex="0"
            aria-label="Option one: this discovery was interesting. Click here to provide feedback."
            title="interesting"
            @click="handleFeedback('interesting')"
          >
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
              data-icon="thumbs-up"
              class="svg-inline--fa fa-thumbs-up DiscoveryFeedback-button__icon"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
          ...
          ><button
            ...
            @click="handleFeedback('not_interesting')"
          >
            <svg
              aria-hidden="true"
              focusable="false"
              ...
              class="svg-inline--fa fa-thumbs-down DiscoveryFeedback-button__icon"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
...
<style>
  .Dialog-wrap__background {
    margin: 0px;
    padding: 0px;
    boxSizing: border-box;
    backgroundColor: var(--DiscoveryAccentColor, transparent);
  }
  ...
  .HorizontalCard {
    ...
    boxShadow: rgba(0, 0, 0, 0.09) 0px 2px 16px 0px;
    width: 100%;
    marginBottom: 12px;
  }
  ...
  .Stars__star {
    ...
    height: 1em;
    fontSize: 0.875em;
    lineHeight: 0.0714286em;
    textAlign: center;
    marginRight: 0.1em;
    verticalAlign: -0.07143em;
    width: var(--fa-fw-width, 1.25em);
    overflow: visible;
    boxSizing: content-box;
  }

  .DiscoveryFeedback-button {
    margin: 0px;
    overflow: visible;
    textTransform: none;
    appearance: button;
