...
const initBackgroundAnimation = () => {
  anime({
    targets: '.animated-blob',
    scale: [
      {value: 1.05, duration: 4000, easing: 'easeInOutSine'},
      {value: 1, duration: 4000, easing: 'easeInOutSine'}
    ],
    translateX: [
      {value: 15, duration: 5000, easing: 'easeInOutSine'},
