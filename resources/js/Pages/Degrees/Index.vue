      ...
      <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-2/4">
          <div class="bg-white border-2 border-[#db492b]/20 rounded-2xl p-6 shadow-lg shadow-[#db492b]/5 sticky-filter">
            <div class="mb-4">
              <label for="search" class="block text-sm font-semibold text-gray-700 mb-1">{{ __("degrees.search")
                }}</label>
          ...
          <div class="Listings__Results" role="feed" aria-busy="false" aria-live="assertive" aria-atomic="true">
            <div class="Listings__Results__section">
              <div v-if="degrees.data.length > 0">
                <article v-for="(degree, index) in degrees.data" :key="degree.id" :aria-setsize="degrees.meta.total"
                  ...
                  <div class="Box Listings__ResultItem Listings__ResultItem--has-thumbnail Listings__ResultItemCareer">
                    ...
                    <div class="Listings__ResultItem__main">
                      <h3>{{ degree.name }}</h3>
                      <div class="stars">
                        <div class="Stars" :aria-label="`${degree.rating} out of 5`">
                    ...
                    <Link :href="`/degree/${degree.slug}`" class="Listings__ResultItem__link-overlay">
                    <span class="sr-only">{{
                      degree.name
                    }}</span>
                    </Link>
