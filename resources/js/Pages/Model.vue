...
<div class="Discovery__related">
 ...
 <div class="Discovery__related__feedback">
   ...
   <button class="Dialog__back-button alans-butt--grey" tabindex="0" aria-label="Click here to close the dialog and to continue your assessment.">Close</button>
 </div>
</div>
</div>
</div>
